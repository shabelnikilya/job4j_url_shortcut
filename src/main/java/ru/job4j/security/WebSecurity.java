...
import static ru.job4j.security.JWTAuthenticationFilter.REGISTRATION_URL;
...
public class WebSecurity extends WebSecurityConfigurerAdapter {
    ...
    public WebSecurity(SiteService userDetailsService, BCryptPasswordEncoder bCryptPasswordEncoder) {
        this.siteService = userDetailsService;
